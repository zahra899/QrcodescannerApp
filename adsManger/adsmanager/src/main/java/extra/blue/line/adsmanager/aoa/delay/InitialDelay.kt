package extra.blue.line.adsmanager.aoa.delay
...
class InitialDelay(
    ...
    init {
        ...
        if (delayPeriodType == DelayType.DAYS && delayCount > 2) Timber.e("You sure that the InitialDelay set by you is correct?")
    }
